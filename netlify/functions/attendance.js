const { verifyToken, getAttendances, getAttendance, createAttendance, updateAttendance, deleteAttendance } = require('../../controllers/attendanceController');
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log(`Attendance request completed in ${Date.now() - startTime}ms, Response body: ${body}`);
    return {
      statusCode,
      headers,
      body,
